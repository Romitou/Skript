...
//				Variables.setVariable(key, player);
//				return player;
//			}
//		}
//		return t;
...
//					key = keys.next();
//					if (key != null) {
//						next = convertIfOldPlayer(name + key, e, Variables.getVariable(name + key));
...
//		Variables.setVariable("" + name.toString(e), value);
//	}
//
//	@Override
...
//				break;
//			case SET:
//				Variables.setVariable(name.toString(e), delta);
//				break;
//			case RESET:
//				Object x = get(e);
//				if (x == null)
...
//				assert delta != null;
//				if (list) {
//					Map<String, Object> o = (Map<String, Object>) get(e);
